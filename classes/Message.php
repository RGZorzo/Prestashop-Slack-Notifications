...
class Message
{
     ...
     *
     * @param \Zorzo\Slack\Client $client
     * @return void
     */
    ...
    public function attach($attachment)
    {
        ...
        throw new InvalidArgumentException('Attachment must be an instance of Zorzo\\Slack\\Attachment or a keyed array');
    }
